    ...
    <div>
      ...
      >
        <div className="container mx-auto mt-8">
          <div
            className="max-w-md mx-auto flex font-semibold text-2xl items-center bg-slate-400 uppercase
      justify-center shadow-md rounded px-8 py-6 text-white"
          >
            Add Organisation
          </div>
          <form
            className="max-w-md mx-auto bg-purple-200 shadow-md rounded px-8 py-6"
            onSubmit={orgSubmit}
          >
            <div className="mb-4">
              <label
        ...
        <div className="container mx-auto mt-8">
          <div
            className="max-w-md mx-auto flex font-semibold text-2xl items-center bg-blue-300 uppercase
      justify-center shadow-md rounded px-8 py-6 text-white"
          >
            Add Stakeholder
          </div>
          <form
            className="max-w-md mx-auto bg-blue-200 shadow-md rounded px-8 py-6"
